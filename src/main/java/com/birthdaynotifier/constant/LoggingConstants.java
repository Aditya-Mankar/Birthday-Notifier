...
public class LoggingConstants {
    ...
    public static final String message_get_user = "Fetching user with username: ";
    ...
    public static final String success_get_user = "Successfully fetched user with username: ";
    ...
    public static final String fail_get_user = "Failed to fetch user with username: ";
